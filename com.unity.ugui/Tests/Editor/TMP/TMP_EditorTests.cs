...
namespace TMPro
{
    ...
    [Ignore("GUID remapping caused by asset migration needs an editor restart, leading to initial test failures. This will be resolved once uGUI 3.0.0-exp.1 land in trunk.")]
